...
def upgrade():
    ...
    op.create_index('ix_model_hyperparameters', 'models', ['hyperparameters'], unique=False, postgresql_using='gin')
    op.create_index('ix_model_parameters', 'models', ['parameters'], unique=False, postgresql_using='gin')
